...
from eval.gui_grounding.metrics import parse_action, score_records
...
class ParseActionTest(unittest.TestCase):
    ...
    def test_rejects_degenerate_and_out_of_range_boxes(self):
        self.assertEqual(parse_action("lclick [10,20,5,30]").error, "degenerate_bbox")
        self.assertEqual(parse_action("hover [0,0,1001,30]").error, "bbox_out_of_range")
        ...
        metrics = score_records(
            [
                ...
                },
                {
                    ...
                    "target_bbox_1000": [500, 500, 700, 700],
